   ...
   <div class="container my-5">
    <div class="row">
        <div class="col-md-8 mx-auto mb-4">
            <div class="card">
                <img src="<?= htmlspecialchars($berita['img']  ?? '/path/to/default.jpg'); ?>" 
                     class="card-img-top" 
                     alt="Gambar Blog">
                <div class="card-body">
                    <h2 class="card-title"><?= htmlspecialchars($berita['judul']); ?></h2>
                    <p class="text-muted">
                        Dipublikasikan pada: <?= htmlspecialchars($berita['tanggal']); ?> | 
                        Oleh: <?= htmlspecialchars($berita['username'] ?? 'Tidak ada admin'); ?>
                    </p>
                    <p>
