        ...
        <h1>
            ...
            Di Login Guru
                    ...
                    <div class="input-group">
                        <input type="text" name="nip" placeholder="NIP" value="<?php echo htmlspecialchars($_POST['nip'] ?? ''); ?>" />
                        <div class="error-placeholder <?php echo isset($errors['nip']) ? 'active' : ''; ?>">
                            <?php if (isset($errors['nip'])): ?>
                                <p><?php echo htmlspecialchars($errors['nip'][0]); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
